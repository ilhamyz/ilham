...
<form action="" method="GET">
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="search" name="search" placeholder="Masukkan NISN atau Nama Siswa">
    </div>
...
<table class="table table-striped table-bordered">
    ...
    if (isset($_GET['search'])) {
        $keyword = $_GET['search'];
        $sql = "SELECT * FROM siswa, spp, kelas WHERE siswa.id_kelas=kelas.id_kelas AND siswa.id_spp=spp.id_spp AND (siswa.nisn LIKE '%$keyword%' OR siswa.nama LIKE '%$keyword%') ORDER BY nama ASC";
    } else {
